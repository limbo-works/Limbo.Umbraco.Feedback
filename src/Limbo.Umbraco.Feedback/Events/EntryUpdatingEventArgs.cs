...
namespace Limbo.Umbraco.Feedback.Events {
    ...
    /// <summary>
    /// Events args for when a new feedback entry is being updated.
    /// </summary>
    public class EntryUpdatingEventArgs {
        ...
        /// <summary>
        /// Gets a reference to the feedback entry being updated.
        /// </summary>
        ...
        /// <param name="entry">The feedback entry being updated.</param>
        public EntryUpdatingEventArgs(FeedbackService feedbackService, FeedbackEntry entry) {
