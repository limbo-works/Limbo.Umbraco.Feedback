...
namespace Limbo.Umbraco.Feedback.Events {
    ...
    /// <summary>
    /// Events args for when a feedback entry has been updated.
    /// </summary>
    public class EntryUpdatedEventArgs {
        ...
        public EntryUpdatedEventArgs(FeedbackService feedbackService, FeedbackEntry entry) {
